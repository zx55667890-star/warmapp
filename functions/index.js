...
const MODELS = [
  ...
  { name: 'gemini-2.5-flash-lite',  label: 'FALLBACK_1', useSearch: true },
  { name: 'gemini-2.5-flash',       label: 'FALLBACK_2', useSearch: true },
  { name: 'gemini-3-flash-preview', label: 'FALLBACK_3', useSearch: true },
